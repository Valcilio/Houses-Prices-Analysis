...
def premises_plan():
    ...
    st.write('Purchasing opportunities > at this point the analysis was carried out in ascending '
             ...
             'of bedrooms and bathrooms. All these aspects in ascending order and the more they were '
             'fulfilled, the better the ranking being in that order: Bad - Good - Great - Excellent.')
